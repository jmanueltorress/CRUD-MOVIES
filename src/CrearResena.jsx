    ...
    return (
        <div className="container mx-auto shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] mt-4 p-6">
            ...
            <form className='pt-4' onSubmit={submitHandler}>
                <div className="mb-6">
                    <label htmlFor="id_usuario" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Usuario</label>
                ...
                <div className="mb-6">
                    <label htmlFor="id_pelicula" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pelicula</label>
